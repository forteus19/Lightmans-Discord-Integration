...
public class LDIConfig {
	...
	public static class Server
	{
		...
		public final ForgeConfigSpec.ConfigValue<List<? extends String>> errorAlertLevels;
		...
		Server(ForgeConfigSpec.Builder builder)
		{
			...
			this.consoleCommandPrefix = builder
					...
					.define("prefix", "/");
			this.errorAlertLevels = builder
					.defineList("errorAlertLevels", Lists.newArrayList("ERROR"), o -> o instanceof String);
